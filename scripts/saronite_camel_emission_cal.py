...
MONEY_SUPPLY         = 90000000000000000
GENESIS_BLOCK_REWARD     = 1000000000
FINAL_SUBSIDY = 1000000000
COIN_EMISSION_MONTH_INTERVAL = 2 #months
...
if __name__ == "__main__":
    f = open("saronite_camel_emmission.txt", "w")
    calculate_emssion_speed()
    if COIN_EMISSION_MONTH_INTERVAL == 2:
        print "\n\n\n"
        f.write("\n\n\n")
